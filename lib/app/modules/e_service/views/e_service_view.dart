...
class EServiceView extends GetWidget<EServiceController> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        EServiceTilWidget(
                          ...
                          content: Obx(() {
                            if (controller.eService.value.description == null) {
                              return SizedBox();
                            }
                            return Text(_eService.description,
  ...
  CarouselSlider buildCarouselSlider(EService _eService) {
    return CarouselSlider(
      ...
      items: _eService.images.map((dynamic media) {
        return Builder(
  ...
  Container buildCarouselBullets(EService _eService) {
    return Container(
      ...
      child: Row(
        ...
        children: _eService.images.map((dynamic media) {
          return Container(
            width: 20.0,
            height: 5.0,
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Ui.getPrice(controller.booking.value.getSubtotal(),
