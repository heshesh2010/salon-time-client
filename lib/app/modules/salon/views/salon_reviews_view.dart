...
class SalonReviewsView extends GetWidget<SalonReviewsController> {
  @override
  Widget build(BuildContext context) {
    return SalonTilWidget(
      ...
      content: Column(
        children: [
          Text(controller.salon.value.rate.toString(),
          ...
          Text(
            "Reviews (%s)"
                .trArgs([controller.salon.value.totalReviews.toString()]),
