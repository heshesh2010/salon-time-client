...
class SalonDetailsView extends GetWidget<SalonController> {
  @override
    ...
    return Obx(() {
      return Wrap(
        children: [
          ...
          //         return SizedBox();
          //       } else {
          //         return Text(controller.salon.value.description,
      ...
      content: (controller.salon.value.availabilityHours?.isEmpty ?? false)
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                var _availabilityHour = controller.salon.value
                    .groupedAvailabilityHours()
                    .entries
                    .elementAt(index);
                var _data = controller.salon.value
