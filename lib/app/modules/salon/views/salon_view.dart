...
class SalonView extends GetWidget<SalonController> {
  @override
      ...
      if (!_salon.hasData) {
        ...
        return Scaffold(
          floatingActionButton: controller.currentIndex.value == 1
              ...
              : null,
          bottomNavigationBar:
              controller.currentIndex.value == 1 ? buildBottomWidget() : null,
  ...
  CarouselSlider buildCarouselSlider(Salon _salon) {
    return CarouselSlider(
      ...
      items: _salon.images.map((dynamic media) {
        return Builder(
  ...
  Container buildCarouselBullets(Salon _salon) {
    return Container(
      ...
      child: Row(
        ...
        children: _salon.images.map((dynamic media) {
          return Container(
            width: 20.0,
            height: 5.0,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _salon?.distance == null
                  ? Container()
                  : Text(
                      Ui.getDistance(_salon?.distance ?? 0.0),
                      style: Get.textTheme.caption,
                    ),
            ],
          ),
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              Ui.getPrice(_booking.getSubtotal(),
