...
class ServicesListItemWidget extends GetWidget<SalonEServicesController> {
                          ...
                          children: <Widget>[
                            ...
                            Wrap(
                              ...
                              children: List.generate(
                                  _service.categories.length, (index) {
                                return Container(
                      ...
                      ElevatedButton(
                          onPressed: () {
                            Get.toNamed(Routes.E_SERVICE, arguments: {
                              'eService': _service,
                              'heroTag': 'salon_services_list_item'
                            });
                          },
