...
class SalonRepository {
  ...
  Future<List<EService>> getEServices(String salonId, List<String> categories,
      {int page}) {
  ...
  Future<List<EService>> getPopularEServices(
      ...
      {int page}) {
    return _laravelApiClient.getSalonPopularEServices(
        salonId, categories, page);
  }

  Future<List<EService>> getMostRatedEServices(
      String salonId, List<String> categories,
      {int page}) {
    return _laravelApiClient.getSalonMostRatedEServices(
        salonId, categories, page);
  }
  ...
  Future<List<EService>> getAvailableEServices(
      String salonId, List<String> categories,
      {int page}) {
    return _laravelApiClient.getSalonAvailableEServices(
        salonId, categories, page);
  }
  ...
  Future<List<EService>> getFeaturedEServices(
      String salonId, List<String> categories,
      {int page}) {
    return _laravelApiClient.getSalonFeaturedEServices(
        salonId, categories, page);
  }

  Future<List> getAvailabilityHours(
      String eProviderId, DateTime date, String employeeId, bool isFreelancer) {
    return _laravelApiClient.getAvailabilityHours(
        eProviderId, date, employeeId, isFreelancer);
  }
}
